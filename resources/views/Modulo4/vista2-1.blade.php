...
<div class="contenedorpe">
	<h2 style="text-align: center;font-weight: bold;">Resultado de Indicadores</h2>
	<p style="line-height: 23px;margin-left: 80px;font-size: 18px;text-align: justify;">
		<br>
        ¡Muy bien! has finalizado el módulo de indicadores y con este la planeación estratégica para tu empresa.
        <br>
        En este espacio podrás visualizar un resumen con: Los objetivos, estrategias y el indicador con el cual se va a
        medir la consecución del objetivo previsto.</p>
</div>
