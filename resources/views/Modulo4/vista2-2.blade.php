...
@section('content')
    ...
    <div class="col-md-auto mx-auto mt-auto">
        ...
        <a href="{{ route('vista2-1') }}" style="color:white;" class="retroceder btn btn-planeem waves-effect waves-light">Anterior</a>
    </div>
                ...
                success:function(data){
                    ...
                    if(data != null){0
                        for(i of data){
                            ...
                            let html = '<div class="row" id="Resumen_modulo4">';
                           ...
                           // html = html + '<div class="col-md-4" type="hidden" id="contenedor_objetivo"><h3>'+i.objetivos_v+'</h3></div>';
                            html = html + '<div class="col-md-4 d-flex" id="contenedor_objetivo"><h3 class="justify-content-center align-self-center">'+i.Objetivos+'</h3></div>';
                            html = html + '<span class="icon-arrow-right2" style="font-size: 62px;color: #0AB5A0;margin: 74px 0px;"></span>';
                            html = html + '<div class="col-md-2 d-flex" id="contenedor_objetivo2"><h5>'+i.nombre_indicador+'</h5></div>';
                            html = html + '<span class="icon-arrow-right2" style="font-size: 62px;color: #0AB5A0;margin: 74px 0px;"></span>'

                            html = html + '<div class="col-md-4" id="contenedor_objetivo2">';
                            html = html + '<textarea placeholder="Que quiere medir" id="inputContendor">'+i.lo_que_se_va_a_medir+'</textarea>';
                            html = html + '<textarea placeholder="Sobre que lo quiere medir" id="inputContendor">'+i.sobre_lo_que_se_va_a_medir+'</textarea>';
                            html = html + '</div>'
                            html = html + '</div>'
